...
export class RemoteSettings extends RemoteSettingsInterface {
    ...
    static init(
        ...
        const result = UniFFIScaffolding.callSync(
            65, // uniffi_remote_settings_fn_constructor_remotesettings_new
    ...
    async downloadAttachmentToPath(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            66, // uniffi_remote_settings_fn_method_remotesettings_download_attachment_to_path
    ...
    async getRecords() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            67, // uniffi_remote_settings_fn_method_remotesettings_get_records
            FfiConverterTypeRemoteSettings.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async getRecordsSince(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            68, // uniffi_remote_settings_fn_method_remotesettings_get_records_since
            FfiConverterTypeRemoteSettings.lowerReceiver(this),
...
export class RemoteSettingsClient extends RemoteSettingsClientInterface {
    ...
    async collectionName() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            69, // uniffi_remote_settings_fn_method_remotesettingsclient_collection_name
    ...
    async getAttachment(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            70, // uniffi_remote_settings_fn_method_remotesettingsclient_get_attachment
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
    ...
    async getRecords(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            71, // uniffi_remote_settings_fn_method_remotesettingsclient_get_records
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
    ...
    async getRecordsMap(
        ...
        FfiConverterBoolean.checkType(syncIfEmpty);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            72, // uniffi_remote_settings_fn_method_remotesettingsclient_get_records_map
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
            FfiConverterBoolean.lower(syncIfEmpty),
        )
        return handleRustResult(
    ...
    async shutdown() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            73, // uniffi_remote_settings_fn_method_remotesettingsclient_shutdown
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async sync() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            74, // uniffi_remote_settings_fn_method_remotesettingsclient_sync
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
        )
        return handleRustResult(
            result,
...
export class RemoteSettingsService extends RemoteSettingsServiceInterface {
    ...
    static init(
        ...
        const result = UniFFIScaffolding.callSync(
            75, // uniffi_remote_settings_fn_constructor_remotesettingsservice_new
    ...
    async makeClient(
        ...
        FfiConverterString.checkType(collectionName);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            76, // uniffi_remote_settings_fn_method_remotesettingsservice_make_client
    ...
    async sync() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            77, // uniffi_remote_settings_fn_method_remotesettingsservice_sync
            FfiConverterTypeRemoteSettingsService.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    updateConfig(
        ...
        FfiConverterTypeRemoteSettingsConfig2.checkType(config);
        const result = UniFFIScaffolding.callSync(
            78, // uniffi_remote_settings_fn_method_remotesettingsservice_update_config
            FfiConverterTypeRemoteSettingsService.lowerReceiver(this),
            FfiConverterTypeRemoteSettingsConfig2.lower(config),
        )
        return handleRustResult(
