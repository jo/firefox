...
extern "C" {
  ...
  void uniffi_init_rust_components_fn_func_initialize(RustCallStatus*);
...
class CallbackInterfaceMethodLoginsEncryptorDecryptorDecrypt final : public AsyncCallbackMethodHandlerBase {
private:
  // Rust arguments
  FfiValueRustBuffer mCiphertext{};

public:
  CallbackInterfaceMethodLoginsEncryptorDecryptorDecrypt(
      uint64_t aUniffiHandle,
      RustBuffer aCiphertext)
    : AsyncCallbackMethodHandlerBase(
        "EncryptorDecryptor.callback_interface_logins_encryptor_decryptor_decrypt",
        aUniffiHandle
    ), mCiphertext(FfiValueRustBuffer::FromRust(aCiphertext))
  {
  }
...
extern "C" void callback_interface_logins_encryptor_decryptor_decrypt(
  ...
  UniquePtr<AsyncCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodLoginsEncryptorDecryptorDecrypt>(aUniffiHandle, aCiphertext);
  AsyncCallbackMethodHandlerBase::ScheduleAsyncCall(std::move(handler), &gUniffiCallbackHandlerLoginsEncryptorDecryptor);
}


class CallbackInterfaceMethodLoginsEncryptorDecryptorEncrypt final : public AsyncCallbackMethodHandlerBase {
private:
  // Rust arguments
  FfiValueRustBuffer mCleartext{};

public:
  CallbackInterfaceMethodLoginsEncryptorDecryptorEncrypt(
      uint64_t aUniffiHandle,
      RustBuffer aCleartext)
    : AsyncCallbackMethodHandlerBase(
        "EncryptorDecryptor.callback_interface_logins_encryptor_decryptor_encrypt",
        aUniffiHandle
    ), mCleartext(FfiValueRustBuffer::FromRust(aCleartext))
  {
  }
...
extern "C" void callback_interface_logins_encryptor_decryptor_encrypt(
  ...
  UniquePtr<AsyncCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodLoginsEncryptorDecryptorEncrypt>(aUniffiHandle, aCleartext);
  AsyncCallbackMethodHandlerBase::ScheduleAsyncCall(std::move(handler), &gUniffiCallbackHandlerLoginsEncryptorDecryptor);
}
...
class CallbackInterfaceMethodLoginsKeyManagerGetKey final : public AsyncCallbackMethodHandlerBase {
private:
  // Rust arguments

public:
  CallbackInterfaceMethodLoginsKeyManagerGetKey(
      uint64_t aUniffiHandle)
    : AsyncCallbackMethodHandlerBase(
        "KeyManager.callback_interface_logins_key_manager_get_key",
        aUniffiHandle
    )
  {
  }
...
extern "C" void callback_interface_logins_key_manager_get_key(
  ...
  UniquePtr<AsyncCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodLoginsKeyManagerGetKey>(aUniffiHandle);
  AsyncCallbackMethodHandlerBase::ScheduleAsyncCall(std::move(handler), &gUniffiCallbackHandlerLoginsKeyManager);
}
...
class CallbackInterfaceMethodLoginsPrimaryPasswordAuthenticatorGetPrimaryPassword final : public AsyncCallbackMethodHandlerBaseRustBuffer {
private:
  // Rust arguments
...
public:
  CallbackInterfaceMethodLoginsPrimaryPasswordAuthenticatorGetPrimaryPassword(
      ...
      uint64_t aUniffiCallbackData)
    : AsyncCallbackMethodHandlerBaseRustBuffer(
        "PrimaryPasswordAuthenticator.callback_interface_logins_primary_password_authenticator_get_primary_password",
        aUniffiHandle,
...
class CallbackInterfaceMethodLoginsPrimaryPasswordAuthenticatorOnAuthenticationSuccess final : public AsyncCallbackMethodHandlerBaseVoid {
private:
  // Rust arguments
...
public:
  CallbackInterfaceMethodLoginsPrimaryPasswordAuthenticatorOnAuthenticationSuccess(
      ...
      uint64_t aUniffiCallbackData)
    : AsyncCallbackMethodHandlerBaseVoid(
        "PrimaryPasswordAuthenticator.callback_interface_logins_primary_password_authenticator_on_authentication_success",
        aUniffiHandle,
        aUniffiCompleteCallback,
        aUniffiCallbackData
    )
...
class CallbackInterfaceMethodLoginsPrimaryPasswordAuthenticatorOnAuthenticationFailure final : public AsyncCallbackMethodHandlerBaseVoid {
private:
  // Rust arguments
...
public:
  CallbackInterfaceMethodLoginsPrimaryPasswordAuthenticatorOnAuthenticationFailure(
      ...
      uint64_t aUniffiCallbackData)
    : AsyncCallbackMethodHandlerBaseVoid(
        "PrimaryPasswordAuthenticator.callback_interface_logins_primary_password_authenticator_on_authentication_failure",
        aUniffiHandle,
        aUniffiCompleteCallback,
        aUniffiCallbackData
    )
